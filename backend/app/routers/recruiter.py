...
async def list_candidates(
    ...
    decision: Optional[str] = Query(
        None,
        description="One of: shortlisted, rejected, undecided, hold, bookmarked",
    ),
    status: Optional[str] = Query(
        None,
        description="Derived status: invited, interview_completed, shortlisted, rejected, on_hold",
    ),
    ...
    date_from: Optional[str] = Query(None, description="ISO lower bound on interview date"),
    date_to: Optional[str] = Query(None, description="ISO upper bound on interview date"),
